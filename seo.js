...
const NOMBRE_NEGOCIO = 'Budines by Sofi';
...
function metaTagsProducto(producto, urlBase) {
  ...
  // Ojo con la redaccion automatica: la categoria sale de la planilla y
  // puede venir en singular o plural ("Budín" / "Budines"), asi que no
  // podemos pegarle un adjetivo al lado (quedaria "budines artesanal").
  // Por eso el adjetivo va en una oracion aparte, sin concordar con nada.
  ...
  const foto = urlAbsoluta(urlBase, producto.foto || (producto.fotos && producto.fotos[0]) || '/budines-logo-final.jpg');
